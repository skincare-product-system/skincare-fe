...
//         {
//           text: 'Đăng nhập',
//           onPress: () => nav.navigate('OrderTrackingNavigator', { screen: 'LoginScreen' })
//         },
//         {
//           text: 'Đóng'
//         }
...
//                     screen: 'OrderTrackingNavigator',
//                     params: { status: ORDER_STATUS.PENDING }
//                   })
//                 }
//               >
...
//                   nav.navigate('StackNavigator', {
//                     screen: 'OrderTrackingNavigator',
//                     params: { status: ORDER_STATUS.DELIVERING }
//                   })
//                 }
//               >
//                 <View style={styles.iconCircle}>
...
//             <TouchableOpacity style={styles.menuItem} onPress={() => nav.navigate('WishListScreen')}>
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.menuItem}>
          ...
          <Text style={styles.menuText} onPress={() => nav.navigate('AddressNavigator', { screen: 'MyAddressScreen' })}>
            Địa chỉ của tôi
          </Text>
          <Feather name='chevron-right' size={20} color='#ccc' />
        </TouchableOpacity>
